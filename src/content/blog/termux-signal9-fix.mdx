...
pubDate: 'Jul 14 2022'
description: 'fix termux signal 9 error in android 12 devices without external PC (phantomService)'
heroImage: '/Signal-9.svg'
---
...
This video show how to fix signal 9 issue without a PC
using a app called [Shizuku](https://play.google.com/store/apps/details?id=moe.shizuku.privileged.api&hl=en&gl=US) for adb interface to your android device
and using termux to execute command that fixes signal 9 issues.

<YouTube id="GCN0gh1yXSs" />
